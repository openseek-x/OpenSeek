...
const roots: string[] = []
// The normal test remains a performance signal. Partitioned coverage adds V8
// instrumentation and runs on smaller hosted machines, so retain the resolver
// correctness check there without turning its fixed 10-second benchmark limit
// into a platform-capacity failure.
const resolutionTimeoutMs = process.env.DSH_COVERAGE_PARTITION_MODE === '1' ? 60_000 : 10_000
