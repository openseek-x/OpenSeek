...
- A manual synchronization released to OpenSeek follows the [OpenSeek Desktop distribution](2026-09-16-openseek-desktop-distribution.md); this workflow still neither publishes nor merges that branch.
