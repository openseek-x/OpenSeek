---
description: "Desktop-only update settings and non-modal update notices over Electron's context-isolated updater bridge."
...
This package is activated only by `apps/desktop/config/desktop.patch.yml`; keep the main-process updater protocol and its browser validation in lockstep when changing the wire contract.
